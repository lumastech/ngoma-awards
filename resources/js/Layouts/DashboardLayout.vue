        ...
        <div class="md:flex h-full bg-sky-50">
            <aside @click="sideToggle" class="z-50 md:w-[60px] xl:w-[300px] hover:w-[300px] shrink-0 bg-primary-50 py-7 h-full md:m-2 rounded-md overflow-x-hidden overflow-y-auto absolute md:static md:translate-x-0 -translate-x-full transition">
                <nav class="flex flex-col px-2 md:px-2">
                    ...
                    <Link href="/awards" class="flex flex-nowrap place-items-center overflow-hidden text-primary-500 px-4 py-2 rounded md:rounded-lg bg-white shadow-sm my-1 hover:bg-primary-500 hover:text-white transition">
                        <i class="fa-solid fa-ticket w-7 mr-3"></i>
                        Awards
                    </Link>
            ...
            <main class="flex-auto h-full text-gray-500">
                <div class="flex justify-between p-4 mb-4 place-items-center border-b">
                    ...
                    <div class="flex space-x-4">
                        <Link :href="route('profile.show')" class="rounded-full p-2 bg-primary-50 border border-primary-400 w-10 h-10 flex place-items-center justify-center text-primary-500 ">
                        ...
                        <!-- menu button -->
                        <button @click="sideToggle" class="md:hidden rounded-md p-2 bg-primary-50 border border-primary-400  h-10 flex gap-2 place-items-center justify-center text-primary-500 hover:bg-primary-500 hover:text-white transition ">
